...
class EditScaleUseCaseTest {
  ...
  public EditScaleUseCaseTest(@Mock EditScaleOutputPort outputPort) {
    ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
    var useCaseValidator = new UseCaseBeanValidator<EditScaleInput>(factory.getValidator());

    this.outputPort = outputPort;
    this.useCase = new EditScaleUseCase(useCaseValidator, outputPort);
  }
