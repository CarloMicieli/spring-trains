...
*/
package io.github.carlomicieli.catalog.scales.usecases.createscale;
...
public class CreateScaleUseCase
    extends AbstractUseCase<CreateScaleInput, CreateScaleOutput, CreateScaleOutputPort> {
  public CreateScaleUseCase(
      UseCaseInputValidator<CreateScaleInput> inputValidator, CreateScaleOutputPort outputPort) {
    super(inputValidator, outputPort);
  }

  @Override
  protected void handle(CreateScaleInput input) {
