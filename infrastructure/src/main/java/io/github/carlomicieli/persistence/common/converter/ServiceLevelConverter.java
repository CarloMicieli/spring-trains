...
import io.github.carlomicieli.catalog.catalogitems.rollingstocks.ServiceLevel;
...
public class ServiceLevelConverter implements AttributeConverter<ServiceLevel, String> {
  ...
  @Override
  public ServiceLevel convertToEntityAttribute(String s) {
    if (Strings.isNullOrEmpty(s)) {
      return null;
    }

    return ServiceLevel.parse(s);
  }
}
