...
public class DeliveryDateConverter implements AttributeConverter<DeliveryDate, String> {
  @Override
  public String convertToDatabaseColumn(DeliveryDate deliveryDate) {
  ...
  @Override
  public DeliveryDate convertToEntityAttribute(String s) {
    if (Strings.isNullOrEmpty(s)) {
      return null;
    }

    return DeliveryDate.parseDeliveryDate(s);
  }
}
